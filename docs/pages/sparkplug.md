...
```json
{
  ...
  "metrics": [{
    "name": "state/tc/tlc/timeplan",
    "timestamp": 1486144502122,
    "dataType": "Integer",
    "value": 1
  },{
    "name": "state/tc/tlc/timeplan/source",
    "timestamp": 1486144502122,
    "dataType": "String",
    "value": "calendar"
  }],
...
```json
{
  "timestamp": 1486144502122,
  "metrics": [{
    "name": "state/tc/tlc/cyclecounter",
    "timestamp": 1486144502122,
    "dataType": "Integer",
    "value": 24
  },{
    "name": "state/tc/tlc/basecyclecounter",
    "timestamp": 1486144502122,
    "dataType": "Integer",
    "value": 12
  },{
    "name": "state/tc/tlc/stage",
    "timestamp": 1486144502122,
    "dataType": "Integer",
    "value": 2
  },{
    "name": "state/tc/tlc/signalgroupstatus",
    "timestamp": 1486144502122,
    "dataType": "Template",
    "value": {
...
If the timeplan was succesfully changed a data update will be send back reporting the plan number in tc/tlc/state/timeplan, and the source in tc/tlc/state/timeplan/source.
